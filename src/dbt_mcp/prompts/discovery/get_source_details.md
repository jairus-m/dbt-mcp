...
- Using only source_name may return incorrect results if multiple sources have tables with the same name
...
source_name: The table name within the source. Only use this when uniqueId is unavailable.
</parameters>
